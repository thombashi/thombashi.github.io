...
var curPosition,curLeft,curCSSTop,curTop,curOffset,curCSSLeft,calculatePosition,position=jQuery.css(elem,"position"),curElem=jQuery(elem),props={};"static"===position&&(elem.style.position="relative"),curOffset=curElem.offset(),curCSSTop=jQuery.css(elem,"top"),curCSSLeft=jQuery.css(elem,"left"),calculatePosition=("absolute"===position||"fixed"===position)&&(curCSSTop+curCSSLeft).indexOf("auto")>-1,calculatePosition?(curPosition=curElem.position(),curTop=curPosition.top,curLeft=curPosition.left):(curTop=parseFloat(curCSSTop)||0,curLeft=parseFloat(curCSSLeft)||0),jQuery.isFunction(options)&&(options=options.call(elem,i,jQuery.extend({},curOffset))),null!=options.top&&(props.top=options.top-curOffset.top+curTop),null!=options.left&&(props.left=options.left-curOffset.left+curLeft),"using"in options?options.using.call(elem,props):curElem.css(props)}},jQuery.fn.extend({offset:function(options){if(arguments.length)return void 0===options?this:this.each(function(i){jQuery.offset.setOffset(this,options,i)});var docElem,win,rect,doc,elem=this[0];if(elem)return elem.getClientRects().length?(rect=elem.getBoundingClientRect(),rect.width||rect.height?(doc=elem.ownerDocument,win=getWindow(doc),docElem=doc.documentElement,{top:rect.top+win.pageYOffset-docElem.clientTop,left:rect.left+win.pageXOffset-docElem.clientLeft}):rect):{top:0,left:0}},position:function(){if(this[0]){var offsetParent,offset,elem=this[0],parentOffset={top:0,left:0};return"fixed"===jQuery.css(elem,"position")?offset=elem.getBoundingClientRect():(offsetParent=this.offsetParent(),offset=this.offset(),jQuery.nodeName(offsetParent[0],"html")||(parentOffset=offsetParent.offset()),parentOffset={top:parentOffset.top+jQuery.css(offsetParent[0],"borderTopWidth",!0),left:parentOffset.left+jQuery.css(offsetParent[0],"borderLeftWidth",!0)}),{top:offset.top-parentOffset.top-jQuery.css(elem,"marginTop",!0),left:offset.left-parentOffset.left-jQuery.css(elem,"marginLeft",!0)}}},offsetParent:function(){return this.map(function(){for(var offsetParent=this.offsetParent;offsetParent&&"static"===jQuery.css(offsetParent,"position");)offsetParent=offsetParent.offsetParent;return offsetParent||documentElement})}}),jQuery.each({scrollLeft:"pageXOffset",scrollTop:"pageYOffset"},function(method,prop){var top="pageYOffset"===prop;jQuery.fn[method]=function(val){return access(this,function(elem,method,val){var win=getWindow(elem);return void 0===val?win?win[prop]:elem[method]:void(win?win.scrollTo(top?win.pageXOffset:val,top?val:win.pageYOffset):elem[method]=val)},method,val,arguments.length)}}),jQuery.each(["top","left"],function(i,prop){jQuery.cssHooks[prop]=addGetHookIf(support.pixelPosition,function(elem,computed){if(computed)return computed=curCSS(elem,prop),rnumnonpx.test(computed)?jQuery(elem).position()[prop]+"px":computed})}),jQuery.each({Height:"height",Width:"width"},function(name,type){jQuery.each({padding:"inner"+name,content:type,"":"outer"+name},function(defaultExtra,funcName){jQuery.fn[funcName]=function(margin,value){var chainable=arguments.length&&(defaultExtra||"boolean"!=typeof margin),extra=defaultExtra||(margin===!0||value===!0?"margin":"border");return access(this,function(elem,type,value){var doc;return jQuery.isWindow(elem)?0===funcName.indexOf("outer")?elem["inner"+name]:elem.document.documentElement["client"+name]:9===elem.nodeType?(doc=elem.documentElement,Math.max(elem.body["scroll"+name],doc["scroll"+name],elem.body["offset"+name],doc["offset"+name],doc["client"+name])):void 0===value?jQuery.css(elem,type,extra):jQuery.style(elem,type,value,extra)},type,chainable?margin:void 0,chainable)}})}),jQuery.fn.extend({bind:function(types,data,fn){return this.on(types,null,data,fn)},unbind:function(types,fn){return this.off(types,null,fn)},delegate:function(selector,types,data,fn){return this.on(types,selector,data,fn)},undelegate:function(selector,types,fn){return 1===arguments.length?this.off(selector,"**"):this.off(types,selector||"**",fn)}}),jQuery.parseJSON=JSON.parse,__WEBPACK_AMD_DEFINE_ARRAY__=[],__WEBPACK_AMD_DEFINE_RESULT__=function(){return jQuery}.apply(exports,__WEBPACK_AMD_DEFINE_ARRAY__),!(void 0!==__WEBPACK_AMD_DEFINE_RESULT__&&(module.exports=__WEBPACK_AMD_DEFINE_RESULT__));var _jQuery=window.jQuery,_$=window.$;return jQuery.noConflict=function(deep){return window.$===jQuery&&(window.$=_$),deep&&window.jQuery===jQuery&&(window.jQuery=_jQuery),jQuery},noGlobal||(window.jQuery=window.$=jQuery),jQuery})},function(module,exports,__webpack_require__){"use strict";var AbstractCardGerator=function(){function AbstractCardGerator(_doc,_cardData,_color,_emojiProcessor){this._doc=_doc,this._cardData=_cardData,this._color=_color,this._emojiProcessor=_emojiProcessor,this._color=this.sanitizeColor(this._color)}return AbstractCardGerator.prototype.createCard=function(){var card=this.createElement("div","ui raised "+this.getColor()+" card");return card.appendChild(this.createCardContent()),card.appendChild(this.createExtraCardContent()),card},AbstractCardGerator.prototype.getColor=function(){throw Error("not implemented")},AbstractCardGerator.prototype.createCardHeader=function(){throw Error("not implemented")},AbstractCardGerator.prototype.createCardContent=function(){throw Error("not implemented")},AbstractCardGerator.prototype.createExtraCardContent=function(){throw Error("not implemented")},AbstractCardGerator.prototype.createElement=function(tagName,className){var element=this._doc.createElement(tagName);return element.className=className,element},AbstractCardGerator.prototype.createColumn=function(element,wide){void 0===wide&&(wide="");var column=this.createElement("div",wide+" column");return column.appendChild(element),column},AbstractCardGerator.prototype.sanitizeColor=function(color){var validColorArray=["red","orange","yellow","olive","green","teal","blue","violet","purple","pink","brown","grey","black"];return validColorArray.indexOf(color)>=0?color:""},AbstractCardGerator}();exports.AbstractCardGerator=AbstractCardGerator},function(module,exports,__webpack_require__){"use strict";var repository_1=__webpack_require__(3),user_1=__webpack_require__(4),emoji_1=__webpack_require__(5),$=__webpack_require__(0),CardGeneratorManager=function(){function CardGeneratorManager(_doc){this._doc=_doc}return CardGeneratorManager.prototype.generateCards=function(){var _this=this;Array.prototype.forEach.call(this._doc.getElementsByClassName("ghscard"),function(cardElement){var dataSourcePath=cardElement.getAttribute("src"),iframeHeight=cardElement.getAttribute("iframe-height"),iframeWidth=cardElement.getAttribute("width");null===iframeWidth&&(iframeWidth=480),$.getJSON(dataSourcePath,function(cardData){var cardType=cardData.card_type;if("undefined"!=typeof cardType){var cardMargin=4,iframe=_this._doc.createElement("iframe");iframe.scrolling="no",iframe.frameBorder="0",iframe.marginHeight=""+cardMargin,iframe.marginWidth=""+cardMargin,iframe.width=iframeWidth+"px",iframe.id="iframe"+cardData.name,cardElement.parentNode.insertBefore(iframe,cardElement);var iframeDocument=iframe.contentWindow.document,semanticUiCssLink=iframeDocument.createElement("link");semanticUiCssLink.rel="stylesheet",semanticUiCssLink.href="https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.2.9/semantic.min.css",iframeDocument.head.appendChild(semanticUiCssLink);var emojiCssLink=iframeDocument.createElement("link");emojiCssLink.rel="stylesheet",emojiCssLink.href="https://afeld.github.io/emoji-css/emoji.css",iframeDocument.head.appendChild(emojiCssLink);var contentWidthPx=iframeWidth-2*cardMargin+"px",cssStyle=iframeDocument.createElement("style");cssStyle.type="text/css",cssStyle.appendChild(iframeDocument.createTextNode(".ui.card { width: "+contentWidthPx+"; overflow: hidden; }")),iframeDocument.head.appendChild(cssStyle);var cardGenerator,emojiProcessor=emoji_1.EmojiProcessorFactory.create(cardElement.getAttribute("emoji")),color=cardElement.getAttribute("color");if("repository"===cardType)cardGenerator=new repository_1.RepositoryCardGerator(iframeDocument,cardData,color,emojiProcessor);else{if("user"!==cardType)return;cardGenerator=new user_1.UserCardGerator(iframeDocument,cardData,color,emojiProcessor)}if(iframeDocument.body.appendChild(cardGenerator.createCard()),null!==iframeHeight)iframe.height=String(iframeHeight);else{var clientRect=iframeDocument.documentElement.getBoundingClientRect();iframe.height=clientRect.height+"px"}}}).fail(function(jqXHR,textStatus,errorThrown){})})},CardGeneratorManager}();exports.CardGeneratorManager=CardGeneratorManager},function(module,exports,__webpack_require__){"use strict";var __extends=this&&this.__extends||function(d,b){function __(){this.constructor=d}for(var p in b)b.hasOwnProperty(p)&&(d[p]=b[p]);d.prototype=null===b?Object.create(b):(__.prototype=b.prototype,new __)},base_1=__webpack_require__(1),RepositoryCardGerator=function(_super){function RepositoryCardGerator(doc,cardData,color,emojiProcessor){var _this=_super.call(this,doc,cardData,color,emojiProcessor)||this;return _this.colorMap={a:"red",b:"orange",c:"yellow",d:"olive",e:"green",f:"teal",g:"blue",h:"violet",i:"purple",j:"pink",k:"brown",l:"grey",m:"black",n:"red",o:"orange",p:"yellow",q:"olive",r:"green",s:"teal",t:"blue",u:"violet",v:"purple",w:"pink",x:"brown",y:"grey",z:"black"},_this.colorMap.C="black",_this.colorMap["C++"]="pink",_this.colorMap.Go="teal",_this.colorMap.HTML="red",_this.colorMap.Java="brown",_this.colorMap.Swift="orange",_this.colorMap.JavaScript="yellow",_this.colorMap.Python="blue",_this.colorMap.Ruby="purple",_this.colorMap.Shell="green",_this}return __extends(RepositoryCardGerator,_super),Object.defineProperty(RepositoryCardGerator.prototype,"htmlUrl",{get:function(){return this.getCardData("html_url")},enumerable:!0,configurable:!0}),Object.defineProperty(RepositoryCardGerator.prototype,"language",{get:function(){return this.getCardData("language")},enumerable:!0,configurable:!0}),RepositoryCardGerator.prototype.getColor=function(){if(""!==this._color)return this._color;var color=this.colorMap[this.language];return"undefined"!=typeof color?color:(color=this.colorMap[this.language.charAt(0).toLowerCase()],"undefined"!=typeof color?color:"gray")},RepositoryCardGerator.prototype.createCardHeader=function(){var subheader=this.createElement("div","sub header");subheader.appendChild(this._doc.createTextNode(this.getCardData("owner_name")));var headerContent=this.createElement("div","content");headerContent.appendChild(this.createRepositoryName()),headerContent.appendChild(subheader);var header=this.createElement("div","ui dividing large header");return header.appendChild(this.createOwnerAvatar()),header.appendChild(headerContent),"undefined"!=typeof this.getCardData("latest_tag")&&header.appendChild(this.createTagLabel()),header},RepositoryCardGerator.prototype.createCardContent=function(){var description=this.getCardData("repo_description");null==description&&(description="no description");var descriptionElement=this.createElement("div","description");descriptionElement.innerHTML=this._emojiProcessor.processEmoji(description);var content=this.createElement("div","content");return content.appendChild(this.createCardHeader()),content.appendChild(descriptionElement),content},RepositoryCardGerator.prototype.createExtraCardContent=function(){var grid=this.createElement("div","ui equal width center middle aligned grid");grid.appendChild(this.createColumn(this.createLanguage(),"five wide")),grid.appendChild(this.createColumn(this.createStars())),grid.appendChild(this.createColumn(this.createForks())),grid.appendChild(this.createColumn(this.createHomePage()));var extraContent=this.createElement("div","extra content");return extraContent.appendChild(grid),extraContent},RepositoryCardGerator.prototype.getCardData=function(key){return this._cardData[key]},RepositoryCardGerator.prototype.createRepositoryName=function(){var repoLink=this._doc.createElement("a");repoLink.href=this.htmlUrl,repoLink.appendChild(this._doc.createTextNode(this.getCardData("name")));var repoName=this._doc.createElement("span");return repoName.appendChild(repoLink),repoName},RepositoryCardGerator.prototype.createOwnerAvatar=function(){var avatar=this._doc.createElement("img");avatar.className="ui avatar image",avatar.title="Avatar of "+this.getCardData("owner_name"),avatar.src=this.getCardData("avatar_url");var ownerLink=this._doc.createElement("a");return ownerLink.href=this.getCardData("owner_html_url"),ownerLink.appendChild(avatar),ownerLink},RepositoryCardGerator.prototype.createTagLabel=function(){var tagLabel=this.createElement("div","ui "+this.getColor()+" mini label");tagLabel.title="Latest tag",tagLabel.appendChild(this._doc.createTextNode(this.getCardData("latest_tag")));var releaseLink=this._doc.createElement("a");return releaseLink.href=this.htmlUrl+"/releases",releaseLink.appendChild(tagLabel),releaseLink},RepositoryCardGerator.prototype.createLanguage=function(){var language=this.createElement("div","ui "+this.getColor()+" label");return language.title="Language",language.appendChild(this._doc.createTextNode(this.language)),language},RepositoryCardGerator.prototype.createStars=function(){var icon=this.createElement("i","star black icon");icon.title="Stargazers";var stargazersLink=this._doc.createElement("a");return stargazersLink.href=this.htmlUrl+"/stargazers",stargazersLink.title="Stargazers count",stargazersLink.appendChild(icon),stargazersLink.appendChild(this._doc.createTextNode(this.getCardData("stargazers_count"))),stargazersLink},RepositoryCardGerator.prototype.createForks=function(){var icon=this.createElement("i","fork black icon");icon.title="Forks";var forksLink=this._doc.createElement("a");return forksLink.href=this.htmlUrl+"/network",forksLink.title="Forks count",forksLink.appendChild(icon),forksLink.appendChild(this._doc.createTextNode(this.getCardData("forks_count"))),forksLink},RepositoryCardGerator.prototype.createHomePage=function(){var homepageElement,homepageUrl=this.getCardData("repo_homepage");if(null==homepageUrl)homepageElement=this.createElement("i","home disabled icon"),homepageElement.title="Homepage not found";else{var icon=this.createElement("i","home black icon");icon.title="Homepage";var homepageLink=this._doc.createElement("a");homepageLink.href=homepageUrl,homepageLink.appendChild(icon),homepageElement=homepageLink}return homepageElement},RepositoryCardGerator}(base_1.AbstractCardGerator);exports.RepositoryCardGerator=RepositoryCardGerator},function(module,exports,__webpack_require__){"use strict";var __extends=this&&this.__extends||function(d,b){function __(){this.constructor=d}for(var p in b)b.hasOwnProperty(p)&&(d[p]=b[p]);d.prototype=null===b?Object.create(b):(__.prototype=b.prototype,new __)},base_1=__webpack_require__(1),UserCardGerator=function(_super){function UserCardGerator(doc,cardData,color,emojiProcessor){return _super.call(this,doc,cardData,color,emojiProcessor)||this}return __extends(UserCardGerator,_super),Object.defineProperty(UserCardGerator.prototype,"htmlUrl",{get:function(){return this.getCardData("html_url")},enumerable:!0,configurable:!0}),UserCardGerator.prototype.getColor=function(){return this._color},UserCardGerator.prototype.createCardHeader=function(){var userInfoColumn=this.createElement("div","column");userInfoColumn.appendChild(this.createUserHeaderText()),userInfoColumn.appendChild(this.createUserInfoList());var row=this.createElement("div","centered row"),avatarColumn=this.createElement("div","six wide center aligned column");avatarColumn.appendChild(this.createAvatar()),row.appendChild(avatarColumn),row.appendChild(userInfoColumn);var grid=this.createElement("div","ui equal width grid");grid.appendChild(row);var header=this.createElement("div","ui dividing header");return header.appendChild(grid),header},UserCardGerator.prototype.createCardContent=function(){var description=this.getCardData("bio");null==description&&(description="no description");var descriptionElement=this.createElement("div","description");descriptionElement.innerHTML=this._emojiProcessor.processEmoji(description);var content=this.createElement("div","content");return content.appendChild(this.createCardHeader()),content.appendChild(descriptionElement),content},UserCardGerator.prototype.createExtraCardContent=function(){var statistics=this.createElement("div","ui mini statistics"),publicRepos=this.getCardData("public_repos");if(null!==publicRepos&&Number(publicRepos)>0){var link=this._doc.createElement("a");link.href=this.getCardData("html_url")+"?tab=repositories",link.appendChild(this._doc.createTextNode("repositories")),statistics.appendChild(this.createStatisticItem(publicRepos,link))}var stars=this.getCardData("stars");if(null!==stars&&Number(stars)>0){var link=this._doc.createElement("a");link.href=this.getCardData("html_url")+"?tab=stars",link.appendChild(this._doc.createTextNode("stars")),statistics.appendChild(this.createStatisticItem(stars,link))}var followers=this.getCardData("followers");if(null!==followers&&Number(followers)>0){var link=this._doc.createElement("a");link.href=this.getCardData("html_url")+"?tab=followers",link.appendChild(this._doc.createTextNode("followers")),statistics.appendChild(this.createStatisticItem(followers,link))}var following=this.getCardData("following");if(null!==following&&Number(following)>0){var link=this._doc.createElement("a");link.href=this.getCardData("html_url")+"?tab=following",link.appendChild(this._doc.createTextNode("following")),statistics.appendChild(this.createStatisticItem(following,link))}var contributions=this.getCardData("contributions");if(null!==contributions&&Number(contributions)>0){var value=this.createElement("div","value");value.appendChild(this._doc.createTextNode(contributions));var label=this.createElement("div","label");label.appendChild(this._doc.createTextNode("contributions"));var statistic=this.createElement("div","statistic");statistic.appendChild(value),statistic.appendChild(label),statistics.appendChild(statistic)}var publicGists=this.getCardData("public_gists");if(null!==publicGists&&Number(publicGists)>0){var link=this._doc.createElement("a");link.href="https://gist.github.com/"+this.getCardData("id"),link.appendChild(this._doc.createTextNode("gists")),statistics.appendChild(this.createStatisticItem(publicGists,link))}var extraContent=this.createElement("div","extra content");return extraContent.appendChild(statistics),extraContent},UserCardGerator.prototype.createAvatar=function(){var avatar=this._doc.createElement("img");avatar.className="ui small centered rounded image",avatar.title="Avatar of "+this.getCardData("profile_name"),avatar.src=this.getCardData("avatar_url");var htmlLink=this._doc.createElement("a");return htmlLink.href=this.getCardData("html_url"),htmlLink.appendChild(avatar),htmlLink},UserCardGerator.prototype.createUserHeaderText=function(){var userLink=this._doc.createElement("a");userLink.href=this.htmlUrl;var header=this.createElement("div","ui medium header");if(header.appendChild(userLink),null!==this.getCardData("profile_name")){userLink.appendChild(this._doc.createTextNode(this.getCardData("profile_name")));var subheader=this.createElement("div","sub header");subheader.appendChild(this._doc.createTextNode(this.getCardData("id"))),header.appendChild(subheader)}else userLink.appendChild(this._doc.createTextNode(this.getCardData("id")));return header},UserCardGerator.prototype.createUserInfoList=function(){var userInfoList=this.createElement("div","ui mini list");if(null!==this.getCardData("company")){var text=this.createElement("div","content");text.appendChild(this._doc.createTextNode(this.getCardData("company")));var icon=this.createElement("i","users icon");icon.title="Company";var company=this.createElement("div","item");company.appendChild(icon),company.appendChild(text),userInfoList.appendChild(company)}if(null!==this.getCardData("location")){var text=this.createElement("div","content");text.appendChild(this._doc.createTextNode(this.getCardData("location")));var icon=this.createElement("i","marker icon");icon.title="Location";var location_1=this.createElement("div","item");location_1.appendChild(icon),location_1.appendChild(text),userInfoList.appendChild(location_1)}if(null!==this.getCardData("email")){var mailLink=this._doc.createElement("a");mailLink.href="mailto:"+this.getCardData("email"),mailLink.appendChild(this._doc.createTextNode(this.getCardData("email")));var emailContent=this.createElement("div","content");emailContent.appendChild(mailLink);var icon=this.createElement("i","mail icon");icon.title="email";var emailItem=this.createElement("div","item");emailItem.appendChild(icon),emailItem.appendChild(emailContent),userInfoList.appendChild(emailItem)}if(null!==this.getCardData("blog")){var blogLink=this._doc.createElement("a");blogLink.href=this.getCardData("blog"),blogLink.appendChild(this._doc.createTextNode(blogLink.hostname));var blocgContent=this.createElement("div","content");blocgContent.appendChild(blogLink);var emailItem=this.createElement("div","item");emailItem.appendChild(this.createElement("i","linkify icon")),emailItem.appendChild(blocgContent),userInfoList.appendChild(emailItem)}return userInfoList},UserCardGerator.prototype.createStatisticItem=function(statisticValue,link){var value=this.createElement("div","value");value.appendChild(this._doc.createTextNode(statisticValue));var label=this.createElement("div","label");label.appendChild(link);var statistic=this.createElement("div","statistic");return statistic.appendChild(value),statistic.appendChild(label),statistic},UserCardGerator.prototype.getCardData=function(key){return this._cardData[key]},UserCardGerator}(base_1.AbstractCardGerator);exports.UserCardGerator=UserCardGerator},function(module,exports,__webpack_require__){"use strict";var __extends=this&&this.__extends||function(d,b){function __(){this.constructor=d}for(var p in b)b.hasOwnProperty(p)&&(d[p]=b[p]);d.prototype=null===b?Object.create(b):(__.prototype=b.prototype,new __)},AbstractEmojiProcessor=function(){function AbstractEmojiProcessor(){this._regexpEmoji=new RegExp(":[a-zA-Z0-9_-]+:","gm")}return AbstractEmojiProcessor.prototype.processEmoji=function(text){throw new Error("not implemented")},AbstractEmojiProcessor}(),EmojiNop=function(_super){function EmojiNop(){return null!==_super&&_super.apply(this,arguments)||this}return __extends(EmojiNop,_super),EmojiNop.prototype.processEmoji=function(text){return text},EmojiNop}(AbstractEmojiProcessor),EmojiRemover=function(_super){function EmojiRemover(){return null!==_super&&_super.apply(this,arguments)||this}return __extends(EmojiRemover,_super),EmojiRemover.prototype.processEmoji=function(text){return text.replace(this._regexpEmoji,"")},EmojiRemover}(AbstractEmojiProcessor),EmojiResolver=function(_super){function EmojiResolver(){return null!==_super&&_super.apply(this,arguments)||this}return __extends(EmojiResolver,_super),EmojiResolver.prototype.processEmoji=function(text){var matchList=text.match(this._regexpEmoji);if(null===matchList)return text;for(var emojiMap=new Object,_i=0,matchList_1=matchList;_i<matchList_1.length;_i++){var emojiText=matchList_1[_i],emojiId=emojiText;emojiId=emojiId.substr(1),emojiId=emojiId.substr(0,emojiId.length-1),emojiMap[emojiText]='<i class="em em-'+emojiId+'"></i>'}for(var emojiText in emojiMap)text=text.replace(new RegExp(emojiText,"g"),emojiMap[emojiText]);return text},EmojiResolver}(AbstractEmojiProcessor),EmojiProcessorFactory=function(){function EmojiProcessorFactory(){}return EmojiProcessorFactory.create=function(processorType){return null===processorType?new EmojiResolver:"nop"===processorType?new EmojiNop:"remove"===processorType?new EmojiRemover:"resolve"===processorType?new EmojiResolver:new EmojiNop},EmojiProcessorFactory}();exports.EmojiProcessorFactory=EmojiProcessorFactory},function(module,exports,__webpack_require__){"use strict";var manager_1=__webpack_require__(2),$=__webpack_require__(0);!function(window,$){$(window).on("load",function(){var generator_card=new manager_1.CardGeneratorManager(document);generator_card.generateCards()})}(window,$)}]);